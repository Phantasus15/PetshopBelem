...
<body>
    <div class="main">
        <div class="container mt-5">
            ...
            // Buscar os pedidos realizados pelo cliente
            $query = "SELECT p.id AS pedido_id, p.total, p.data_pedido, u.nome AS nome_cliente 
                  FROM pedidos p 
        ...
        <h5>Itens do Pedido:</h5>";
                    ...
                    $query_itens = "SELECT i.produto_id, i.quantidade, i.preco_unitario, pr.nome AS nome_produto 
                                FROM itens_pedido i 
