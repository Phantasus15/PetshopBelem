            ...
            <?php foreach ($pedidos as $pedido_id => $pedido): ?>
                <div class="card mb-3">
                    <div class="card-header">
                        ...
                        <strong>Tipo de Entrega:</strong> <?= $pedido['info']['tipo_entrega'] ?> <!-- Exibindo tipo de entrega -->
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <form method="POST" class="form-inline">
                            ...
                            <select name="status" class="form-control mr-2">
                                ...
                                <option value="Aguardando Retirada" <?= $pedido['info']['status'] == 'Aguardando Retirada' ? 'selected' : '' ?>>
                                    Aguardando Retirada
                                </option>
